...
7. Shipping Delays
Identify the number of orders where the shipping date is later than 3 days after the order date.
...
Find the top 10 sellers based on total sales value.
